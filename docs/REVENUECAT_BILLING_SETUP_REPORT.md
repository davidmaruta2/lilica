...
11. Complete store listings, privacy/policy declarations, review assets, and explicit production release approval. **Apple side partially done 20 September 2026:** privacy policy/terms/support pages published at lilica.co.uk; App Store Connect description, keywords, subtitle, promotional text, copyright, category (Lifestyle), and age rating declaration are all set. Still outstanding: store screenshots (distinct from the subscription-review screenshot), App Review contact/demo info, and the actual "submit for review" action. Google Play's equivalent listing has not yet been started. See `docs/REVISION_LOG.md`'s 20 September entry.
